...
<---- d e f i n i � r e n d e  w o o r d e n ---->
...
META
HX BE00 CONSTANT USART          \ : USART-DATA   X ) ;
HX BE01 CONSTANT USART-STATUS   \ : USART-STATUS X 1 #) ;
HX BE02 CONSTANT USART-MODE     \ : USART-MODE   X 2 #) ;
HX BE03 CONSTANT USART-CMD      \ : USART-CMD    X 3 #) ;
FORTH

\ Voor de assembler in de target Forth ================

\ ==================== multi-creating (AN) ================
\ Groepsgewijs woorden defini�ren.
...
META-WORDS:
  ...
  RSHIFT     RSHIFT
  USART      USART   ( -- targa )
  USART-STATUS USART-STATUS ( -- targa )
  USART-MODE   USART-MODE   ( -- targa )
  USART-CMD    USART-CMD    ( -- targa )
  ;;;MAIS;;;   ;;;MAIS;;;
